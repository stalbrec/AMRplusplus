...
Create conda environment (and install nextflow & mamba):

```
conda create --name nf nextflow mamba
```

Clone repo with specific legacy branch:

```
git clone -b legacy https://github.com/stalbrec/AMRPlusPlus
```
